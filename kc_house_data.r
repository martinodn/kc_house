...
#plot(model2)
hist(model2$residuals, breaks = 100, main = "Frequency of residuals of the model", xlab="Residuals")
...
idx.valid2<-which(folds==9, arr.ind=TRUE)
boxplot(train[idx.valid2,19])
boxplot(train[-idx.valid2,19])


idx.valid3<-which(folds==7, arr.ind=TRUE)
boxplot(train[idx.valid3,19])
boxplot(train[-idx.valid3,19])
